...
class ConfiguracionAplicacion:
    ...
    def como_config_flask(self) -> dict[str, object]:
        return {
            ...
            "RUTA_BASE_SCRIPTS": self.ruta_base_scripts,
            "RUTA_BASE_ENV_SCRIPTS": self.ruta_base_env_scripts,
            "RUTA_BASE_LOGS_TAREAS": self.ruta_base_logs_tareas,
            "RUTA_BASE_LOGS_SISTEMA": self.ruta_base_logs_sistema,
            "RUTA_BASE_LOGS_WORKER": self.ruta_base_logs_worker,
            "RUTA_CONTROL_RUNTIME": self.ruta_control_runtime,
            "USUARIO_ADMIN_DEFECTO": self.usuario_admin_defecto,
            "PASSWORD_ADMIN_DEFECTO": self.password_admin_defecto,
            "FACTORY_RESET_LOCK_TIMEOUT_SEGUNDOS": self.factory_reset_lock_timeout_segundos,
            "FACTORY_RESET_PREVIEW_TTL_SEGUNDOS": self.factory_reset_preview_ttl_segundos,
            "FACTORY_RESET_HABILITADO": self.factory_reset_habilitado,
            "FACTORY_RESET_DB_TARGET": self.factory_reset_db_target,
            "FACTORY_RESET_DB_ALLOWED_TARGETS": self.factory_reset_db_allowed_targets,
            "FACTORY_RESET_DB_SERVER": self.factory_reset_db_server,
            "FACTORY_RESET_DB_USER": self.factory_reset_db_user,
            "FACTORY_RESET_DB_PASSWORD": self.factory_reset_db_password,
            "FACTORY_RESET_DB_ENCRYPT": self.factory_reset_db_encrypt,
            "FACTORY_RESET_DB_TRUST_SERVER_CERTIFICATE": self.factory_reset_db_trust_server_certificate,
            "FACTORY_RESET_SQLCMD": self.factory_reset_sqlcmd,
            "FACTORY_RESET_SQLCMD_TIMEOUT_SEGUNDOS": self.factory_reset_sqlcmd_timeout_segundos,
            "FACTORY_RESET_APP_NAME_PREFIX": self.factory_reset_app_name_prefix,
