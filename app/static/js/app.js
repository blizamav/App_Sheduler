document.addEventListener("DOMContentLoaded", () => {
    ...
    const fasesFactoryReset = {
        ...
        CUARENTENA_FILESYSTEM: ["Respaldando archivos runtime", "FILESYSTEM", 1],
        ADQUIRIENDO_APPLOCK: ["Adquiriendo bloqueo SQL interno", "TRANSACCION", 2],
        EJECUTANDO_RESET_IN_PLACE: ["Reconstruyendo base actual", "TRANSACCION", 2],
        CONFIRMANDO_COMMIT: ["Confirmando transaccion SQL", "TRANSACCION", 2],
        VALIDANDO_RESULTADO: ["Validando resultado final", "VALIDACION", 3],
        LIMPIANDO_CUARENTENA: ["Eliminando cuarentena temporal", "VALIDACION", 3],
        COMPLETADO: ["Restablecimiento completado", "VALIDACION", 4],
        ROLLBACK_FILESYSTEM: ["Restaurando archivos runtime", "FILESYSTEM", 1],
