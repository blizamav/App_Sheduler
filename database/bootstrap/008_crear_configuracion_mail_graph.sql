/*
    Bootstrap actual - Configuracion global Mail Automatico Graph
    ...
    Definicion limpia derivada de la migracion 020.
    La migracion correctiva 021 de QA no forma parte de este bootstrap.
*/
